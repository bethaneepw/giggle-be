...
const { getApi, getAllTickets, getTicketById, } = require("./src/controllers/controllers");
const { getEvents, getEventById, postEvent, deleteEvent, } = require("./src/controllers/events.controllers");
const { getAllUsers, postUser, deleteUser, getUserById, } = require("./src/controllers/users.controllers");
app.use(cors());
